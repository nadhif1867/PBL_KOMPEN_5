...
//                 return response()->json(['success' => true, 'message' => 'Permintaan mahasiswa DITERIMA. Mahasiswa dapat melaksanakan penugasan.']);
//             } catch (\Exception $e) {
//                 return response()->json(['success' => false, 'message' => 'Gagal menerima permintaan mahasiswa: ' . $e->getMessage()]);
//             }
//         }

//         return response()->json(['success' => true, 'message' => 'Permintaan mahasiswa DITOLAK. Status berhasil diperbarui.']);
//     }
