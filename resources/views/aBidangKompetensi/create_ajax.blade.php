        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input value="" type="text" name="nama_bidkom" id="nama_bidkom" class="form-control" required>
                    <small id="error-nama_bidkom" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Tag Bidang Kompetensi</label>
                    <input value="" type="text" name="tag_bidkom" id="tag_bidkom" class="form-control" required>
