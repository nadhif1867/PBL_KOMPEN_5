<form action="{{ url('/aMahasiswaAlpha/import_ajax') }}" method="POST" id="form-import" enctype="multipart/form-data">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_mahasiswa.xlsx') }}" class="btn btn-success btn-sm" download><i class="fa fa-file-excel"></i> Download</a>
