...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            <button onclick="modalAction('{{ url('dManageKompen/create_ajax') }}')" class="btn btn-sm btn-success mt-1 fa fa-user"> Tambah</button>
        </div>
    </div>
    <div class="card-body">
        @if (session('success'))
...
<script>
    ...
    $(document).ready(function() {
        dataLevel = $('#tabel_kompen').DataTable({
            ...
            ajax: {
                "url": "{{ url('dManageKompen/list') }}", // Endpoint untuk mengambil data kategori
                "dataType": "json",
                "type": "POST",
                "data": function(d) {
